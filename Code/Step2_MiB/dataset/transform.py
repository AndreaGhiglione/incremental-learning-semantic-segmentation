...
class RandomRotation(object):
    ...
    def __call__(self, img, lbl):
        ...
        if lbl is not None:
            ...
            # bug rotate torchvision 0.5
            # return F.rotate(img, angle, self.resample, self.expand, self.center, fill=(0,)), \
            #        F.rotate(lbl, angle, self.resample, self.expand, self.center, fill=(0,))
        else:
            return F.rotate(img, angle, self.resample, self.expand, self.center)
            # bug rotate torchvision 0.5
            # return F.rotate(img, angle, self.resample, self.expand, self.center, fill=(0,))
