...
def get_argparser():
    ...
    parser.add_argument("--context_path", type=str, default='resnet50',
                        choices=['resnet18', 'resnet50', 'resnet101'], help='backbone for the the Context Path (def: resnet50)')
    parser.add_argument("--pretrained_path", type=str, default=None, help='path for pretrained backbone for the Context Path')
    ...
    parser.add_argument("--smooth", action='store_true', default=False,
                        help='if apply CRF post-processing (default: True)')
